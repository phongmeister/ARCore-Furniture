...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneVisualizer : MonoBehaviour
    {
        ...
        public void Initialize(DetectedPlane plane)
        {
            ...
            if (m_DetectedPlane.PlaneType == DetectedPlaneType.Vertical) //ผนัง
            {
                m_MeshRenderer.material.SetColor("_GridColor", k_PlaneColors[5]);
            }
            else if (m_DetectedPlane.PlaneType == DetectedPlaneType.HorizontalDownwardFacing) //เพดาน
            {
                m_MeshRenderer.material.SetColor("_GridColor", k_PlaneColors[2]);
            }
            else if (m_DetectedPlane.PlaneType == DetectedPlaneType.HorizontalUpwardFacing) //พื้น
            {
