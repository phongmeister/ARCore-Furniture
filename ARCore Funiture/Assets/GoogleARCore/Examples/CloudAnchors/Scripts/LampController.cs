...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    public class LampController : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            m_LampMesh = transform.Find("mesh_lamp").gameObject;
            m_LampMesh.SetActive(false);
        }
