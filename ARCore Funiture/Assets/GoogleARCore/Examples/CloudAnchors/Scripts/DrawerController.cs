...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    public class DrawerController : MonoBehaviour
    {
        ...
        /// </summary>
        private GameObject m_DrawerMesh;
        ...
        public void Awake()
        {
            ...
            m_DrawerMesh = transform.Find("mesh_drawer").gameObject;
            m_DrawerMesh.SetActive(false);
        }
