...
#pragma warning disable 618
    public class DeskController : NetworkBehaviour
...
#pragma warning restore 618
        ...
        public void Awake()
        {
            ...
            m_DeskMesh = transform.Find("mesh_desk").gameObject;
            m_DeskMesh.SetActive(false);
        }
...
#pragma warning restore 618
        ...
        {
            var objectController = GameObject.Find("CloudAnchorsExampleController")
                                                  .GetComponent<CloudAnchorsExampleController>();
            objectController.SetWorldOrigin(anchorTransform);
